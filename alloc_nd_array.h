 ...
 */
extern void* alloc_nd_array (const size_t sizes[_RESTRICT], size_t dims, size_t elem_size);
 ...
 */
extern void* calloc_nd_array (const size_t sizes[_RESTRICT], size_t dims, size_t elem_size);
 ...
 */
extern bool calculate_nd_array_size (const size_t sizes[_RESTRICT], size_t dims, size_t elem_size, size_t* RESTRICT result_ptrs_size, size_t* RESTRICT result_padding_size, size_t* RESTRICT result_total_elements);
