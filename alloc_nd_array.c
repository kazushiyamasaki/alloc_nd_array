...
bool calculate_nd_array_size (const size_t sizes[_RESTRICT], size_t dims, size_t elem_size, size_t* RESTRICT result_ptrs_size, size_t* RESTRICT result_padding_size, size_t* RESTRICT result_total_elements) {
...
void* allocate_and_initialize_nd_array (const size_t sizes[_RESTRICT], size_t dims, size_t elem_size, size_t size_ptrs, size_t size_padding, size_t total_elements, allocFuncPtr alloc_func) {
...
void* alloc_nd_array (const size_t sizes[_RESTRICT], size_t dims, size_t elem_size) {
...
void* calloc_nd_array (const size_t sizes[_RESTRICT], size_t dims, size_t elem_size) {
	size_t size_ptrs, size_padding, total_elements;
	if (!calculate_nd_array_size(sizes, dims, elem_size, &size_ptrs, &size_padding, &total_elements)) {
...
void* alloc_nd_array_manual_padding (const size_t sizes[_RESTRICT], size_t dims, size_t padding_bytes, size_t elem_size) {
...
void* calloc_nd_array_manual_padding (const size_t sizes[_RESTRICT], size_t dims, size_t padding_bytes, size_t elem_size) {
	size_t size_ptrs, unused, total_elements;
	if (!calculate_nd_array_size(sizes, dims, elem_size, &size_ptrs, &unused, &total_elements)) {
