 ...
 */
extern void* alloc_nd_array_manual_padding (const size_t sizes[_RESTRICT], size_t dims, size_t padding_bytes, size_t elem_size);
 ...
 */
extern void* allocate_and_initialize_nd_array (const size_t sizes[_RESTRICT], size_t dims, size_t elem_size, size_t size_ptrs, size_t size_padding, size_t total_elements, allocFuncPtr alloc_func);
